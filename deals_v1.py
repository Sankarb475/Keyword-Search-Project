...
file = open(r"C:\Users\sbiswas149\Applications\data\VDR\input.txt")
for out in file:
    content = out
...
os.chdir(r"C:\Users\sbiswas149\Applications\data\VDR\output")
...
def keyword_sql():
    db_connection_str = 'mysql+pymysql://root:1097@localhost/PyMy'
    db_connection = create_engine(db_connection_str)

    df = pd.read_sql('SELECT * FROM VDR', con=db_connection)
...
if __name__ == '__main__':
    try:
        df = keyword_sql()
        global drl_file_path
        global root
        
        it_spend = df[df["Category"] == "IT Spend"]["Keyword"].values.tolist()
        it_org = df[df["Category"] == "IT Organization / Roles"]["Keyword"].values.tolist()
        it_apps = df[df["Category"] == "IT Applications"]["Keyword"].values.tolist()
        it_infra = df[df["Category"] == "IT Infrastructure"]["Keyword"].values.tolist()
        it_security = df[df["Category"] == "IT Security and Controls"]["Keyword"].values.tolist()
        it_projects = df[df["Category"] == "IT Projects"]["Keyword"].values.tolist()
        target_tech_fitness = df[df["Category"] == "Target Technology Fitness Scorecard"]["Keyword"].values.tolist()
        misecellaneous = df[df["Category"] == "Misecellaneous"]["Keyword"].values.tolist()
        user_input = df[df["Category"] == "User Input"]["Keyword"].values.tolist()
        ...
        file_path = r"C:\Users\sbiswas149\Applications\data\VDR\output\demo.xlsx"
