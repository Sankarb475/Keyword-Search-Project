...
def sheet_handler(list_details, cell_details, path, page_count, row, i):
    mm1 = [i for i in r1.findall(row[i]) if i and isinstance(i, str)]
    if mm1:
        for keyword in mm1:
    ...
    mm2 = [i for i in r2.findall(row[i]) if i and isinstance(i, str)]                   
    if mm2:
        for keyword in mm2:
            outputWriterRawDetail(list_details[0], list_details[1], list_details[2], path, list_details[3], page_count,
    ...
    """
    mm4 = [i for i in r4.findall(row[i]) if i and isinstance(i, str)]
    if mm4:
        for keyword in mm4:
            print(keyword)
            outputWriterRawDetail(list_details[0], list_details[1], list_details[2], path, list_details[3], page_count,
    ...
    mm5 = [i for i in r5.findall(row[i]) if i and isinstance(i, str)]
    if mm5:
        for keyword in mm5:
            outputWriterRawDetail(list_details[0], list_details[1], list_details[2], path, list_details[3], page_count,
                    keyword, "IT Security and Controls", cell_details)
                    
    mm6 = [i for i in r6.findall(row[i]) if i and isinstance(i, str)]
    if mm6:
        for keyword in mm6:
            outputWriterRawDetail(list_details[0], list_details[1], list_details[2], path, list_details[3], page_count,
                    keyword, "IT Projects", cell_details)
                    
    mm7 = [i for i in r7.findall(row[i]) if i and isinstance(i, str)]
    if mm7:
        for keyword in mm7:
            outputWriterRawDetail(list_details[0], list_details[1], list_details[2], path, list_details[3], page_count,
                    keyword, "Target Technology Fitness Scorecard", cell_details)
                    
    mm8 = [i for i in r8.findall(row[i]) if i and isinstance(i, str)]
    if mm8:
        for keyword in mm8:
            outputWriterRawDetail(list_details[0], list_details[1], list_details[2], path, list_details[3], page_count,
